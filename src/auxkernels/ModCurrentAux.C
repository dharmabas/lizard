...
{
return (_electrical_conductivity[_qp] * _potential_E_int_grad[_qp](_component)) + (_electrical_conductivity[_qp] * _seebeck_coefficient[_qp] * _temperature_grad[_qp](_component));
