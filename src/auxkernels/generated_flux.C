...
params.addParam<MaterialPropertyName>("thermal_conductivity", "Thermal Conductivity", "Property name of the thermal conductivity material property");
...
{
  return -_thermal_conductivity[_qp] * _temperature_grad[_qp](_component) - _seebeck_coefficient[_qp] * _temperature[_qp] * (_electrical_conductivity[_qp] * _potential_E_int_grad[_qp](_component) + _seebeck_coefficient[_qp] * _electrical_conductivity[_qp] * _temperature_grad[_qp](_component));
}
