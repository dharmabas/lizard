...
{
  Real Relec = 0.0;
  Relec += _grad_test[_i][_qp] * _seebeck_coefficient[_qp]  * _temperature[_qp] * _electrical_conductivity[_qp] * _grad_u[_qp] * _len_scale;
...
{
   return _grad_test[_i][_qp] * _seebeck_coefficient[_qp]  * _temperature[_qp] * _electrical_conductivity[_qp] * _grad_phi[_j][_qp] * _len_scale;
}
