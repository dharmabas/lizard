...
ResidualT::computeQpResidual()
{
  return ((-_grad_test[_i][_qp](0)) * (-_thC[_qp] * _T_grad[_qp](0)) +
          (-_grad_test[_i][_qp](0)) * (-_ecC[_qp] * _sbC[_qp] * _sbC[_qp] * _T[_qp] * _T_grad[_qp](0)) + (-_grad_test[_i][_qp](0)) * (-_ecC[_qp] * _sbC[_qp] * _T[_qp] * _potential_E_int_grad[_qp](0)) + _test[_i][_qp] * (-_ecC[_qp] * _potential_E_int_grad[_qp](0) *
                            _potential_E_int_grad[_qp](0)) + _test[_i][_qp] * (-_ecC[_qp] * _sbC[_qp] *
                            _T_grad[_qp](0) * _potential_E_int_grad[_qp](0))) + ((-_grad_test[_i][_qp](1)) * (-_thC[_qp] * _T_grad[_qp](1)) +
          (-_grad_test[_i][_qp](1)) *
              (-_ecC[_qp] * _sbC[_qp] *
               _sbC[_qp] * _T[_qp] * _T_grad[_qp](1)) +
          (-_grad_test[_i][_qp](1)) * (-_ecC[_qp] * _sbC[_qp] *
                                       _T[_qp] * _potential_E_int_grad[_qp](1)) +
          _test[_i][_qp] * (-_ecC[_qp] * _potential_E_int_grad[_qp](1) *
                            _potential_E_int_grad[_qp](1)) +
          _test[_i][_qp] * (-_ecC[_qp] * _sbC[_qp] *
                            _T_grad[_qp](1) * _potential_E_int_grad[_qp](1))) 
             +
         ((-_grad_test[_i][_qp](2)) * (-_thC[_qp] * _T_grad[_qp](2)) +
          (-_grad_test[_i][_qp](2)) *
              (-_ecC[_qp] * _sbC[_qp] *
               _sbC[_qp] * _T[_qp] * _T_grad[_qp](2)) +
          (-_grad_test[_i][_qp](2)) * (-_ecC[_qp] * _sbC[_qp] *
                                       _T[_qp] * _potential_E_int_grad[_qp](2)) +
          _test[_i][_qp] * (-_ecC[_qp] * _potential_E_int_grad[_qp](2) *
                            _potential_E_int_grad[_qp](2)) +
          _test[_i][_qp] * (-_ecC[_qp] * _sbC[_qp] *
                            _T_grad[_qp](2) * _potential_E_int_grad[_qp](2)));
}

Real
ResidualT::computeQpJacobian()
{
  return ((-_grad_test[_i][_qp](0) * (-_ecC[_qp] * _sbC[_qp] *
                                      _phi[_j][_qp] * _potential_E_int_grad[_qp](0)) +
           (-_grad_test[_i][_qp](0)) * (-_thC[_qp] * _grad_phi[_j][_qp](0)) +
           (-_grad_test[_i][_qp](0)) * (-_sbC[_qp] * _sbC[_qp] *
                                        _ecC[_qp] *
                                        (_phi[_j][_qp] * _T_grad[_qp](0) +
                                         _T[_qp] * _grad_phi[_j][_qp](0))) +
           _test[_i][_qp] * (-_sbC[_qp] * _ecC[_qp] *
          ...
          ((-_grad_test[_i][_qp](1)) * (-_ecC[_qp] * _sbC[_qp] *
           ...
           (-_grad_test[_i][_qp](1)) * (-_sbC[_qp] * _sbC[_qp] *
                                        _ecC[_qp] *
                                        (_phi[_j][_qp] * _T_grad[_qp](1) +
          ...
          ((-_grad_test[_i][_qp](2)) * (-_ecC[_qp] * _sbC[_qp] *
           ...
           (-_grad_test[_i][_qp](2)) * (-_sbC[_qp] * _sbC[_qp] *
                                        _ecC[_qp] *
                                        (_phi[_j][_qp] * _T_grad[_qp](2) +
...
ResidualT::computeQpOffDiagJacobian(unsigned int jvar)
{
  ...
  {
    return ((-_grad_test[_i][_qp](0)) * (-_ecC[_qp] * _sbC[_qp] * _T[_qp] *
                 _grad_phi[_j][_qp](0)) -
            _test[_i][_qp] * (2.0 * _ecC[_qp] * _potential_E_int_grad[_qp](0) *
                                  _grad_phi[_j][_qp](0) + _ecC[_qp] * _sbC[_qp] *
                                  _T_grad[_qp](0) * _grad_phi[_j][_qp](0)) +
            (-_grad_test[_i][_qp](1)) * (-_ecC[_qp] * _sbC[_qp] * _T[_qp] *
                 _grad_phi[_j][_qp](1)) -
            _test[_i][_qp] * (2.0 * _ecC[_qp] * _potential_E_int_grad[_qp](1) *
                                  _grad_phi[_j][_qp](1) +
                              _ecC[_qp] * _sbC[_qp] *
                                  _T_grad[_qp](1) * _grad_phi[_j][_qp](1)) +
            (-_grad_test[_i][_qp](2)) *
                (-_ecC[_qp] * _sbC[_qp] * _T[_qp] *
                 _grad_phi[_j][_qp](2)) -
            _test[_i][_qp] * (2.0 * _ecC[_qp] * _potential_E_int_grad[_qp](2) *
                                  _grad_phi[_j][_qp](2) +
                              _ecC[_qp] * _sbC[_qp] *
                                  _T_grad[_qp](2) * _grad_phi[_j][_qp](2)));
  }
  else
    return 0.0;
}
